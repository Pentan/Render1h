...
template<typename FPType> union Vector3 {
    ...
    //
    Vector3(const FPType ix=0.0, const FPType iy=0.0, const FPType iz=0.0): x(ix), y(iy), z(iz) {}
    ...
    /*
    static inline Vector3 addScalar(const Vector3 v, const FPType s) {
        Vector3 retv;
        retv.x = v.x + s;
        retv.y = v.y + s;
        retv.z = v.z + s;
    ...
    static inline Vector3 subScalar(const Vector3 v, const FPType s) {
        Vector3 retv;
        retv.x = v.x - s;
        retv.y = v.y - s;
        retv.z = v.z - s;
